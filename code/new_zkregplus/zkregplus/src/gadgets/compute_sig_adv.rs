...
impl <F: PrimeField> ComputeSigAdvAdvice<F>{
	...
	pub fn new(
		...
		let (synthesis_res_combo,subsig_res) = 
			Self::gen_synthesis_subsig_combo(acdfa_id,
	...
	fn gen_synthesis_subsig_combo(
		...
		//REMOVE LATER ---------------
		println!("DEBUG USE 6103: scc_prf ================");
		for i in 0..n2{
			println!(" --i: {}, subsig: {}, comp_encoded: {}, comp_subsig: {}, min_req: {}, raw_res: {}, cnt_true: {}, cnt_maybe: {}, row_res: {}", i, 
				scc_prf_subsig[i],
				scc_prf_comp_subsig_encode[i],
				scc_prf_comp_subsig[i],
				scc_prf_min_req[i],
				scc_prf_raw[i],
				scc_prf_cnt_true[i],
				scc_prf_cnt_maybe[i],
...
impl <F:PrimeField> ComputeSigAdvGadget<F>{
	...
	fn validate_synthesis_subsig_combo(&self, 
		...
		//REMOVE LATER -----------
		println!(" -- DEBUG USE 6620.1: step 2.1: get verify vec_sid_op and vec_sid_num: num_cons: {}, n: {}", cs.num_constraints()-n1, n);
		let n1 = cs.num_constraints();
		//REMOVE LATER ----------- ABOVE
		...
		//REMOVE LATER ------------
		println!(" -- --  DEBUG USE 6620.1: step 3.1.1: check sids num_cons: {}, n2: {}", cs.num_constraints()-n1, n2);
		let n1 = cs.num_constraints();
		//REMOVE LATER ----------- ABOVE
		...
		//REMOVE LATER ------------
		println!(" -- --  DEBUG USE 6620.1: step 3.1.2: check count num_cons: {}, n2: {}", cs.num_constraints()-n1, n2);
		let n1 = cs.num_constraints();
		//REMOVE LATER ----------- ABOVE
		...
		//REMOVE LATER ------------
		println!(" -- --  DEBUG USE 6620.1: step 3.2: check raw_res lkup, num_cons: {}, n2: {}, n: {}", cs.num_constraints()-n1, n2, n);
		let n1 = cs.num_constraints();
		//REMOVE LATER ----------- ABOVE
		...
		//REMOVE LATER ------------
		println!(" -- --  DEBUG USE 6620.1: step 3.3: check abs_diff1&2, num_cons: {}, n2: {}, n: {}", cs.num_constraints()-n1, n2, n);
		let n1 = cs.num_constraints();
		//REMOVE LATER ----------- ABOVE
		...
		//REMOVE LATER ------------
		println!(" -- --  DEBUG USE 6620.1: step 3.4: check row_res, num_cons: {}, n2: {}, n: {}", cs.num_constraints()-n1, n2, n);
		let n1 = cs.num_constraints();
		//REMOVE LATER ----------- ABOVE
		...
		//REMOVE LATER ------------
		println!(" -- --  DEBUG USE 6620.1: step 3.5: retrieve scc_res, num_cons: {}, n2: {}, n: {}", cs.num_constraints()-n1, n2, n);
		let n1 = cs.num_constraints();
		//REMOVE LATER ----------- ABOVE
		...
		//REMOVE LATER ------------
		println!(" -- --  DEBUG USE 6620.1: step 4: assemble FINAL RESULT, num_cons: {}, n2: {}, n: {}", cs.num_constraints()-n1, n2, n);
		println!(" # DEBUG USE 6620.9: ALL: num_cons: {}, n2: {}, n: {}", cs.num_constraints()-n0, n2, n);
		//REMOVE LATER ----------- ABOVE
	...
	fn test_compute_sig_adv(){
		...
		let testcases = vec![
			...
			*/ 
			...
			Tcase::new("abcdd122xabx56xxxfghxxabcdd122", "sig5", false, false), //b_ised=F, igc=F
			// */
		];
