...
fn main() {
    ...
    let nova_params = N::preprocess(&mut rng, &nova_preprocess_params, 0).unwrap();
    ...
    let (running_instance, incoming_instance, cyclefold_instance, _) = folding_scheme.instances();
