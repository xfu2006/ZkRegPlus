...
/// Internal investigation probes (T601-C / T602 / T9906).  All are
/// `#[cfg(test)]`-gated and are not part of any paper result's golden
/// path; see `debug_probes/mod.rs`.
pub mod debug_probes;
