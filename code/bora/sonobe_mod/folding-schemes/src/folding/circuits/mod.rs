...
// NEW DEFINITION (as CF2 always applied to bn254 or grumpkin curve)
// its BaseField is its own BasePrimeField, simplify it for
// usig bn254 PairingVar.
pub type CF2<C> = <C as CurveGroup>::BaseField;
pub type CF3<C> = <<C as CurveGroup>::BaseField as Field>::BasePrimeField;
