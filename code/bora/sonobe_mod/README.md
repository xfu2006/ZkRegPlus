# sonobe
This is a MOD of Sonobe (we name it as ``sonobe_mod''). 
We added a new folding scheme in folding-schemes/: foldpot.
It is mainly a modified supernova + cyclefold scheme, integrating
the lookup scheme from Hab22, CQ, and Mangrove, tailored for the
ZkregPlus project (for proving free of large collections of 
malware regex signatures). The branch fork starts from
